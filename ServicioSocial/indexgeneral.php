...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../ServicioSocial/bootsTrap2/css/bootstrap.css"/>
        <link rel="stylesheet" type="text/css" href="../ServicioSocial/bootsTrap2/css/bootstrap-responsive.css"/>
        <style>
            /* GLOBAL STYLES
     -------------------------------------------------- */
    ...
    <body>
        ...
        <div id="myCarousel" class="carousel slide">
            <div class="carousel-inner">
                <div class="item active">
                    <img src="../ServicioSocial/carrusel/indusreel.png" alt="">
                    <div class="container">
                ...
                <div class="item">
                    <img src="../ServicioSocial/carrusel/tecreel.png" alt="">
                    <div class="container">
                        <div class="carousel-caption">
        ...
        <div class="container marketing">
            <div class="featurette">
                <img class="featurette-image pull-right" src="../ServicioSocial/picture/bom.png">
            ...
            <div class="featurette">
                <img class="featurette-image pull-left" src="../ServicioSocial/picture/bom.png">
        ...
        <script src="../ServicioSocial/bootsTrap2/js/jquery.js"></script>
        <script src="../ServicioSocial/bootsTrap2/js/bootstrap.js"></script>
        <script src="../ServicioSocial/bootsTrap2/js/jquery.min.js"></script>
    </body>
</html>
<?php
include './insegeneral.php';
include './indexPrincipal/datosPersonales.php';
