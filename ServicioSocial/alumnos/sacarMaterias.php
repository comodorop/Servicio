...
$fecha=$_SESSION["cicloEscolar"];
$sql = "SELECT cicloescolar, anio FROM fechascicloescolar f, curso c WHERE f.cicloEscolar='$fecha' AND c.id=f.cicloEscolar AND f.idControl=0";
